...
const Detailed = () => {
  return (
    <div className="w-full h-[100vh] flex justify-center items-center bg-[rgba(0,0,0,0.6)]  ">
      <div className="w-[80%] h-[80%] flex justify-between items-center  bg-white shadow-md rounded- overflow-hidden ">
        <img src={img} alt="" className="w-[50%] h-full object-cover" />
        ...
        <div className="ml-[400px]">
          ...
          <div className="flex mb-4">
            ...
            <div className="text-[20px] font-semibold">price2</div>
          </div>
          <div className="text-[20px] font-medium mb-3">rating</div>
